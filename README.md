...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/samdoran/fedora27-ansible.svg)](https://hub.docker.com/r/samdoran/fedora27-ansible/) ![Docker Pulls](https://img.shields.io/docker/pulls/samdoran/fedora27-ansible.svg)
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-fedora27}-ansible:latest"
