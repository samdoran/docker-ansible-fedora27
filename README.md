...
[![Container Repository on Quay](https://quay.io/repository/samdoran/fedora27-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/fedora27-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t fedora27-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "quay.io/samdoran/${MOLECULE_DISTRIBUTION:-fedora27}-ansible:latest"
